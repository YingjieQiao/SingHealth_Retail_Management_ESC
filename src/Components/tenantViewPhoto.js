    ...
    render() { 
        ...
        <div class="container21" >
                ...
                <div className={styles.button_container}>
                    <button type="button" id="buttonstaffview" class={this.getStaffButtonClasses()} onClick={this.showPhotoByStaffHandler}>View Photos Uploaded By Staff</button>
                    <button type="button" id="buttonprevup" class={this.getTenantButtonClasses()} onClick={this.showPhotoByTenantHandler}>View Previously Uploaded Photos</button>
                </div>
